...
typedef struct {
    ...
    /* BEAC: runtime address of the global data area, baked into JIR_GADDR.
     * The caller points this at a buffer before x86_emit; 0 if unused. */
    ...
    uint32_t  ioff[JIR_MAX_INST];     /* JIR inst → code offset */
